...
In the toolbar, their are controls for play/stop, save and load. The final icon toggles between the console and a pattern visualiser. We recommend turning on the visualiser whilst learning Zen. Below the console is displayed the current time \`t\`, the current cycle \`c\`, the number of divisions per cycle \`q\` and the size of the visualiser canvas \`s\`. More on these values later.
