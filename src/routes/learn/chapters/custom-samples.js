...
## Desktop App
If you are using the Zen desktop app, you can load any directory of directories containing samples. The app will automatically load all samples in the directories and subdirectories. Go to File > Load Samples Directory.
`