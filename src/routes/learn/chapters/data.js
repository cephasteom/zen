...
## The Data Object
All data is stored in local storage within your browser so that it persists between sessions. You can access this data using the \`_d\` object, represented by the variable \`_d\`. This object has some simple methods.
...
_d.fetch('https://zendata.cephasteom.co.uk/api/packet', 'packet')


// console.log(_d.packet)
\`\`\`

Once a success message has been printed to the console, you can access the data using \`_d\` and the key you provided, in this case \`_d.packet\`:
