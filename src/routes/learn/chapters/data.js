...
## The Data Object
All data is stored in local storage within your browser so that it persists between sessions. You can access this data using the \`d\` object, represented by the variable \`d\`. This object has some simple methods.
