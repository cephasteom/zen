...
Zen allows you to modulate the parameters of all active events within a stream. The \`.m\` parameter stands for mutation and is an instance of the Pattern class. As with events, when the Pattern returns a value greater than 0, a mutation is triggered. Parameters to be mutated should be prefixed with \`_\`.
\`\`\`js
