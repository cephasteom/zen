...
export class Stream {
     ...
     * @hidden
     */
    evaluateGroup(group: Dictionary, count: number, divisions: number, bpm: number, measurements: number[], probabilities: number[]) : { [key: string]: any } {
    ...
    /** @hidden */
    get(time: number, q: number, s: number, bpm: number, global: Zen, measurements: number[], probabilities: number[]) {
